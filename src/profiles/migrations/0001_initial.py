    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='childs', to='profiles.technology')),
            ],
        ),
        migrations.CreateModel(
            name='UserTechnology',
            fields=[
                ...
                ('technology', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.technology')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_contact', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='social.socialcontacts')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_is_hidden', models.BooleanField(default=False)),
                ('profile_is_hidden', models.BooleanField(default=False)),
                ('activity_status_is_hidden', models.CharField(choices=[('all', 'all'), ('confirmed', 'confirmed'), ('nobody', 'nobody')], default='all', max_length=20)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='privacy', to='profiles.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Follower',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relation', models.CharField(choices=[('not confirmed', 'not confirmed'), ('confirmed', 'confirmed'), ('blacklist', 'blacklist')], default='not confirmed', max_length=20)),
