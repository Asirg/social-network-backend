    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('ml', 'male'), ('fm', 'female')], max_length=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_contact', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='profiles.socialcontacts')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relation', models.CharField(choices=[('not confirmed', 'not confirmed'), ('confirmed', 'confirmed')], default='not confirmed', max_length=20)),
